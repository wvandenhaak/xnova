...
$lang['ins_tx_inst1']     = "Le fichier config.php doit être en CHMOD 666";
$lang['ins_tx_inst2']     = "Vous devez posséder une base de donnée MySQL, <br />l'utilisateur de la base de données doit avoir les droits MySQL <em>REFERENCES</em> pour fonctionner.";
